...
describe('4 - Implemente os casos de teste para a função `circle`', () => {
  ...
  it('Verifica se ao receber um raio, a função `circle` retorna um objeto contedos os valores esperados', () => {
    expect(typeof circle(3)).toBe('object');// Teste se circle retorna um objeto.
  });
    
  it('Verifica se ao receber um raio, a função `circle` retorna um objeto contedos os valores esperados', () => {
    expect(Object.keys(circle(3))).toHaveLength(3)// Teste se o objeto retornado tem 3 propriedades.
  });
  ...
  it('Verifica se ao receber um raio, a função `circle` retorna um objeto contedos os valores esperados', () => {
    ...
    expect(circle(2).radius).toBeCloseTo(2)
